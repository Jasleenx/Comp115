...
my_name = "Jasleen Kaur" # Change to your name
my_github_account = "https://github.com/Jasleenx/Comp115/settings" # Change to your GitHub account
my_hobby = "reading" # Change to your hobby
...
project_interested = project_types[0]
project_another_interested = project_types[1] # Try to change the index from 3 to 4, and run the program :)
